...
if __name__ == "__main__":
    ...
    model.load_checkpoint({
        'layer_in/weights': jnp.ones((D, F), dtype=jnp.float32, device=NamedSharding(mesh, P(None, None))),
        'layer_out/weights': jnp.ones((F, D), dtype=jnp.float32, device=NamedSharding(mesh, P(None, None))),
    })
